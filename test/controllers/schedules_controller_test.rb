...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { group_id: @schedule.group_id, staff_id: @schedule.staff_id } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { group_id: @schedule.group_id, staff_id: @schedule.staff_id } }
